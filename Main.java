...
public class Main{
        public static void main(String[] args) {
                ...
                //creating new hash file and taking input file from BufferedReader
              ...
              //  System.out.println(hm); // Take input as no of employees
		...
		// sort the array and get the difference
                Collections.sort(al);
		...
		// creates an output file and print write the output in it
